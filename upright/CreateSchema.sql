...
CREATE TABLE UR_ATTACHMENT(
	ATTACHMENT_ID INT NOT NULL IDENTITY(1,1),
    ATTACHMENT_NAME NVARCHAR(50) NOT NULL,
    ATTACHMENT_DESCRIPTION NVARCHAR(255) NULL,
	ATTACHMENT_PATH NVARCHAR(255) NOT NULL,
    ATTACHMENT_TYPE INT NOT NULL, --0: INVOICE, 1: CONTRACT, 2: PRODUCT DESCRIPTION, 3: OTHER
    ATTACHMENT_CREATE_DT DATETIME NOT NULL,
    RELATED_OBJECT NVARCHAR(20) NULL,
    RELATED_ID INT NULL,
    CONSTRAINT PK_UR_ATTACHMENT PRIMARY KEY CLUSTERED
    (
	    ATTACHMENT_ID ASC
    )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE S_LOOKUP(
    ...
    LOOKUP_FIELD NVARCHAR(50) NOT NULL UNIQUE,
    CONSTRAINT PK_S_LOOKUP PRIMARY KEY CLUSTERED
    (
	    LOOKUP_ID ASC
    )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]

CREATE TABLE S_LOOKUP_ITEM(
	LOOKUP_ID INT NOT NULL,
    LOOKUP_KEY INT NOT NULL,
    LOOKUP_VALUE NVARCHAR(50) NOT NULL,
    CONSTRAINT PK_S_LOOKUP_ITEM PRIMARY KEY CLUSTERED
    (
	    LOOKUP_ID ASC, LOOKUP_KEY ASC
    )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]